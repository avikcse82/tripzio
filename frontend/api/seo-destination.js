...
// A route page ("delhi-to-manali") is keyed by the FULL route slug, which
// is never itself a photo-database key — those are single destinations
// ("manali"). The arrival city is what should appear behind the hero
// (arriving in Manali is the visual, not leaving Delhi), so route pages
