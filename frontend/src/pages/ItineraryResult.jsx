...
function inrDealsTrackedUrl(targetUrl, campaign) {
...
const GOIBIBO_TRACKED_URL = inrDealsTrackedUrl('https://www.goibibo.com/hotels/', 'hotel')
...
const AIRINDIA_TRACKED_URL = inrDealsTrackedUrl('https://www.airindia.com/en-in/book-flights/', 'cps')
const INDIGO_TRACKED_URL = inrDealsTrackedUrl('https://www.goindigo.in/', 'cps')
...
// convenience link, same pattern as the IRCTC link above. Route-specific SEO page format
// verified live: redbus.in/bus-tickets/{from}-to-{to}.
function slugifyCityName(name) {
  return (name || '').toLowerCase().trim().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, '')
}
function redBusRouteUrl(fromCity, toCity) {
...
function cabSearchUrl(fromCity, toCity) {
