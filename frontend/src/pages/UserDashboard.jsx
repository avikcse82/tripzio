...
export default function UserDashboard() {
  ...
  // Shared with the other dashboard — see utils/extractDateFromText.js.
  // monthOnlyDay preserves this page's long-standing behaviour (15).
  const extractDateFromText = (text) => extractDate(text, { monthOnlyDay: 15 })
                  ...
                  return (
                    <div style={{ marginBottom: '14px', padding: '12px 14px', background: '#f8fafc', border: '1.5px solid #e2e8f0', borderRadius: '14px' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        ...
                        {/* Days chips — pilgrimage-aware via seasonNudge.min_days */}
                        {!hasDays && (
                          <div>
                            ...
                            <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
                              {(() => {
                                ...
                                if (minDays && minDays > 7) {
                                  // Pilgrimage / long circuit — show appropriate chips
